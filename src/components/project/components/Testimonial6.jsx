      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12 lg:gap-y-16">
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              "We were impressed by their attention to detail and support."
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
              ...
              <div className="mb-3 md:mb-4">
                <p className="font-semibold">Lukas Schmidt</p>
                <p>CEO, InnovateX</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="text-md leading-[1.4] font-bold md:text-xl">
              "A fantastic experience that delivered results beyond our goals."
            </blockquote>
            <div className="mt-6 flex w-full flex-col md:mt-8 md:w-auto">
              <div className="mb-4">
                <img
              ...
              <div className="mb-3 md:mb-4">
                <p className="font-semibold">Sophie Keller</p>
                <p>Director, FutureTech</p>
              </div>
              <div className="hidden w-px self-stretch bg-black md:block" />
              <div>
                <img
